...
const achievement_data = [
    ...
    {
        name: "Reach Level 10,000",
        id: "maxprestige_rank",
        reward: "400m xp + <img src='https://www.fsgame.org/web/tempimg/Screenshot_2024-11-19_1.14.10_PM.png' class='img-emoji'> Rank",
        progress: null,
        progress_info: { a: "reach_level", b: 10000, xp: 400000000, b_id: "9" }
    },
...
function loadProfile(){
    ...
    if(badges && badges.includes("baby1")) badgesInclude = badgesInclude + "<img src='https://www.fsgame.org/web/tempimg/game-badges-violet-heart-with-wings-and-crown-game-app-badge-icon-png.webp' class='img-emoji'>";
    ...
    if(badges && badges.includes("9")) badgesInclude = badgesInclude + "<img src='https://www.fsgame.org/web/tempimg/Screenshot_2024-11-19_1.14.10_PM.png' class='img-emoji'>";
    ...
    if(!games_played){
        document.getElementById("games_played_text").innerText = `0/144`
        document.getElementById("games_played").setAttribute("stroke-dasharray", "0, 100")
    } else {
        document.getElementById("games_played_text").innerText = `${games_played.split("||").length - 1}/144`
        document.getElementById("games_played").setAttribute("stroke-dasharray", Math.trunc((games_played.split("||").length - 1) / 144 * 100) + ", 100")
    }
    ...
    document.getElementById("badges_earned_text").innerText = `${badgesEarned.split(" || ").length - 1}/10`
    document.getElementById("badges_earned").setAttribute("stroke-dasharray", Math.trunc((badgesEarned.split(" || ").length - 1) / 10 * 100) + ", 100")
    badges_earned_text
}
